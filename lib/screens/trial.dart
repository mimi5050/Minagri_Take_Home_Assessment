...
Widget build(BuildContext context) {
  ...
  child: ListView(
    children: [
      // Section for the app title 'Task Management App'
      Container(
        color: Colors.deepPurple[400], // Same color as AppBar
        padding: EdgeInsets.all(10),
        child: Text(
          'Task Management App',
          style: TextStyle(fontSize: 18, color: Colors.white), // Kept the text white for visibility
        ),
      ),
      ...
      DrawerHeader(
        decoration: BoxDecoration(
          color: Colors.white, // Setting the background color to white for the profile section
        ),
        child: Row(
          children: [
            CircleAvatar(
              radius: 25,
              backgroundImage: AssetImage('assets/images/profile_picture.png'), // Your profile picture asset
            ),
            SizedBox(width: 10), // Space between the profile picture and text
            Column(
              crossAxisAlignment: CrossAxisAlignment.start, // Aligns text to the start of the column
              children: [
                Text(
                  'Jennifer', 
                  style: TextStyle(fontSize: 16, color: Colors.black), // Text color changed to black
                ),
                Text(
                  'Hi Jennifer, Good Morning!',
                  style: TextStyle(fontSize: 12, color: Colors.black54), // Text color for greeting
                ),
              ],
            ),
          ],
